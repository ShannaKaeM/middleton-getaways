...
// Register blog-posts-accordion component
umbral_register_component('Content', 'blog-posts-accordion', [
    'label' => 'Blog Posts (Accordion)',
    'title' => 'Dynamic Blog Posts - Accordion Style',
    'description' => 'Display dynamic blog posts with advanced query controls and customizable layouts using accordion UI',
    'icon' => '📰',
    'fields' => [
        '_ui_config' => [
            'style' => 'accordion',
